...
import { MockHttpServer } from "./http-test-utils.ts";
...
describe("HTTP Transport", () => {
    ...
    describe("Error Handling", () => {
        it("should handle error responses", async () => {
            mockServer.expectQueryDescriptor({ kind: "query", sql: "SELECT invalid" }).respondWithError({
            ...
            await expect(transport.statement("query", "SELECT invalid", [])).rejects.toThrow(
    ...
    describe("HTTP Error Handling", () => {
        it("should handle HTTP 404 error", async () => {
            ...
            await expect(transport.statement("query", "SELECT 1", [])).rejects.toThrow("HTTP error 404: Not Found");
        });
        ...
        it("should handle HTTP 500 error", async () => {
            ...
            await expect(transport.statement("query", "SELECT 1", [])).rejects.toThrow(
        ...
        it("should handle null response body", async () => {
            ...
            await expect(transport.statement("query", "SELECT 1", [])).rejects.toThrow("Response body is null");
        });
    });
